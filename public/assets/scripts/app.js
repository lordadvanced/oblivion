...
var App = function () {
    ...
    var handleTheme = function () {
        ...
        var setLayout = function () {
			...
			var exampleOption = $('.example-option', panel).val();
			...
			//example
            if (exampleOption === 'fixed') {
                $(".dashboard-stat blue").addClass("example-fixed");
            } else {
                $(".dashboard-stat blue").removeClass("example-fixed");
            }
