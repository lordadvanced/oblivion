...
$("#user_profile_submit").click(function() {
    ...
    $("#change_userprofile_form").submit( function( e ) {
    $.ajax( {
...
$("#dish_submit").click(function() {
    ...
    $("#add_dish_form").submit( function( e ) {
    $.ajax( {
...
function submit_edit_dish(){
    ...
    $("#update_dish_form").submit( function( e ) {
    $.ajax( {
...
//    alert(foodtype_desc);
//    alert(foodtype_name);
    var data = {dishtype_name:dishtype_name,dishtype_desc: dishtype_desc}
...
//    alert(foodtype_desc);
//    alert(foodtype_name);
    var data = {dishtype_name:dishtype_name,dishtype_desc: dishtype_desc,dtype_id:dtype_id};
...
function submit_order(){
   ...
   // alert(date+'|'+time_type+'|'+combo_note);
   var data = {apply_date:date,apply_shift: time_type,combo_note:combo_note,combo_id:combo_id};
    $.ajax( {
      url: '/orders/add/',
      type: 'POST',
      data: data,
...
function submit_order_dish(){
    ...
    //alert(dish_id);
   // alert(date+'|'+time_type+'|'+combo_note);
   var data = {apply_date:date,apply_shift: time_type,combo_note:combo_note,dishes:dish_id};
    $.ajax( {
      url: '/orders/add/',
      type: 'POST',
      data: data,
...
function submit_combo(){
    ...
    var data = {combo_name:combo_name,combo_desc:combo_desc,combo_price:combo_price,dish_list:dish_id};
...
function submit_edit_combo(){
    ...
    var data = {combo_id:combo_id,combo_name:combo_name,combo_desc:combo_desc,combo_price:combo_price,dish_list:dish_id};
