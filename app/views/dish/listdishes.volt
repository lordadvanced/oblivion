<div class="portlet-body ">
							<div class="tabbable tabs-left">
                                ...
                                ?>
									...
									<div class="tab-pane active" id="tab_6_<?php echo $i;?>">
                                    <?php }else { ?>
                                    <div class="tab-pane fade" id="tab_6_<?php echo $i;?>">
                                    <?}?>
                                    <div class="col-md-8" id="load_dishes_<?php echo $i;?>">
                                     <div class="row mix-grid hotpickfood">
                                    <?php 
                                    foreach($item['data'] as $dish){
                                   ?>
										<p>
